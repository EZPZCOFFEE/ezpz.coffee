...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  const routesMap: MetadataRoute.Sitemap = [
    ...
    "/en/white-label",
    "/en/services",
    "/en/services/custom-coffee-bags",
    "/en/services/ready-to-drink",
    "/en/services/nespresso-capsules",
    "/en/about",
    "/en/coffee",
    "/en/faq",
    "/en/contact",
    "/en/shop",
    "/en/terms-of-use",
    "/en/canadian-coffee-industry-statistics-2026",
    "/en/custom-coffee-bags-cost-guide-canada-2026",
    "/en/white-label-coffee-canada-market-report-2026",
    "/en/blog/complete-guide-coffee-roasters-montreal-2026",
    "/en/blog/private-label-coffee-canada-complete-guide",
    ...
    "/en/blog/best-coffee-roasters-montreal-2026",
